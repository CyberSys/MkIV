...
src/units/%.o: ../src/units/%.cpp
	...
	g++ -I /usr/include/OGRE -I/usr/local/include/OGRE -I/usr/local/include/OIS -I/usr/local/include/fmodex -O3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"$@" "$<" -pg
